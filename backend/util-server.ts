...
export interface DockgeACSocket extends Socket {
    userID: number;
...
export function checkLogin(socket : DockgeACSocket) {
    if (!socket.userID) {
...
export async function doubleCheckPassword(socket : DockgeACSocket, currentPassword : unknown) {
